---
layout: seo-guide
title: "Google Sheets Lead Enrichment Template for Car Dealers"
permalink: /google-sheets-lead-enrichment-template-for-car-dealers/
description: "Use GPT for Sheets to enrich BDC leads directly in the dealership spreadsheet: copy formulas, workflow steps, best-fit guidance, internal links, and FAQ for car dealers, BDC teams, used-car lots, and showroom managers."
hero_title: "Google Sheets Lead Enrichment Template for Car Dealers"
hero_subtitle: "Use GPT for Sheets to enrich BDC leads directly in the dealership spreadsheet: copy formulas, workflow steps, best-fit guidance, internal links, and FAQ for car dealers, BDC teams, used-car lots, and showroom managers."
...
inline_cta_text: "Install GPT for Sheets to enrich BDC leads directly in the dealership spreadsheet. Test the prompts on a few rows, then fill down with review columns."
guide_badges:
  - "GPT for Sheets"
  - "AI lead enrichment"
...
quick_start_steps:
  - "Start with A: lead/source \u00b7 B: vehicle interest \u00b7 C: note \u00b7 D: next sales goal."
...
formula_section_intro: "Use these row-2 formulas with columns like A: lead/source \u00b7 B: vehicle interest \u00b7 C: note \u00b7 D: next sales goal. Keep AI outputs in separate columns so results can be reviewed before CRM updates, outreach, or client work."
formula_cards:
  - title: "Create the research brief"
    setup: "A: lead/source \u00b7 B: vehicle interest \u00b7 C: note \u00b7 D: next sales goal"
    formula: |
      =GPT("Create a concise research brief for Google Sheets Lead Enrichment Template for Car Dealers. Inputs: " & A2 & " | " & B2 & " | " & C2 & " | " & D2 & ". Return 3 grounded bullets, one missing-data note, and one next action. Do not invent facts.")
    note: "Use this as the first AI column so every row gets the same reviewable structure."
  - title: "Score fit and priority"
    setup: "A: lead/source \u00b7 B: vehicle interest \u00b7 C: note \u00b7 D: next sales goal \u00b7 E: brief"
    formula: |
      =GPT("Score this internet, showroom, service-lane, or CRM lead CSVs row for fit, urgency, and data quality. Inputs: " & A2 & " | " & B2 & " | " & C2 & " | " & D2 & " | " & E2 & ". Return JSON with score_1_to_5, reason, risk, and next_action.")
  ...
  - title: "Find missing fields"
    setup: "A: lead/source \u00b7 B: vehicle interest \u00b7 C: note \u00b7 D: next sales goal \u00b7 E: output"
    formula: |
  ...
  - title: "Create next-action options"
    setup: "A: lead/source \u00b7 B: vehicle interest \u00b7 C: note \u00b7 D: next sales goal \u00b7 E: score"
    formula: |
...
Google Sheets Lead Enrichment Template for Car Dealers helps car dealers, BDC teams, used-car lots, and showroom managers use AI where list work already happens: inside Google Sheets. Start with internet, showroom, service-lane, or CRM lead CSVs, keep trusted inputs in columns, and use [GPT for Sheets](/gpt-for-sheets/) formulas to produce research briefs, fit scores, next actions, QA notes, and reviewable outreach drafts.
...
## Why dealership teams can turn lead CSVs into BDC notes
...
**Best for:** dealership teams that want clearer follow-up priority, vehicle-interest summaries, and message drafts.

**Not best for:** credit decisions, finance eligibility, legal compliance decisions, or unreviewed customer-facing claims. Treat AI output as a structured draft, not a final decision system.
...
Start with `A: lead/source · B: vehicle interest · C: note · D: next sales goal`. Add separate AI output, score, next-action, and QA columns so every generated field can be reviewed.
