...
guide_badges:
  ...
  - "Lead enrichment"
  - "Sales workflow"
quick_start_title: "Quick start: MSP Prospect Enrichment in Google Sheets with AI"
quick_start_steps:
  - "Add source columns for company, industry, employee range, tech notes, website snippet, offer."
...
formula_section_title: "Copy-paste formulas for MSP Prospect Enrichment in Google Sheets with AI"
...
MSP Prospect Enrichment in Google Sheets with AI helps managed service providers, IT sales teams, MSP owners, and agencies serving MSPs turn spreadsheet rows containing company, industry, employee range, tech notes, website snippet, offer into IT-fit hypotheses, pain-point notes, account summaries, outreach angles, and QA labels. The fastest path is to [install GPT for Sheets](/gpt-for-sheets/), keep source data in visible columns, paste one formula into row 2, review a sample, and then fill down.
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How do I start MSP Prospect Enrichment in Google Sheets with AI?",
      "acceptedAnswer": {
        "@type": "Answer",
