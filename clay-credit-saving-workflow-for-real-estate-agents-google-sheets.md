...
inline_cta_title: "Screen real estate rows in Sheets before spending enrichment credits."
...
guide_badges:
  - "save clay credits real estate"
  - "Realtors"
  - "Copyable formulas"
  - "QA workflow"
quick_start_title: "Quick start"
quick_start_steps:
  - "Create columns for lead source, property or neighborhood note, motivation signal, CRM status, AI output, QA flag, and next action."
...
formula_cards:
  - title: "Summarize each row"
    setup: "A: lead source · B: property or neighborhood note · C: source notes"
    formula: |
      =GPT("Summarize this Realtors row using only the provided evidence. Lead Source: " & A2 & ". Property Or Neighborhood Note: " & B2 & ". Source notes: " & C2 & ". Return summary, useful signal, missing data, and next action.")
...
A reliable save clay credits real estate workflow usually has these columns:

| Column | What to put there | Why it matters |
|---|---|---|
| A | Lead Source | The record or account being researched |
| B | Property Or Neighborhood Note | The visible context that grounds the AI output |
| C | Motivation Signal | The criteria, signal, or status used for classification |
| D | Crm Status | The operational status before the AI step |
...
<div class="seo-guide-inline-cta">
  <div>
    <strong>Screen real estate rows in Sheets before spending enrichment credits.</strong>
...
| Fit | Details |
|---|---|
| Best for | Realtors, real estate agents, small real estate teams who already keep lists, exports, or campaign research in Google Sheets and want a reviewable AI layer. |
...
Do not guarantee savings; say “may reduce unnecessary enrichment spend” and instruct users to verify current pricing/credit rules in Clay documentation.
