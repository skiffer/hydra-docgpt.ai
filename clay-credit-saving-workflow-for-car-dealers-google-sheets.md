...
inline_cta_title: "Prioritize dealership follow-up rows before buying more enrichment."
...
guide_badges:
  - "save clay credits car dealers"
  - "Dealership BDC"
  - "Copyable formulas"
  - "QA workflow"
quick_start_title: "Quick start"
quick_start_steps:
  - "Create columns for lead source, vehicle interest, appointment status, service or trade-in note, AI output, QA flag, and next action."
...
formula_cards:
  - title: "Summarize each row"
    setup: "A: lead source · B: vehicle interest · C: source notes"
    formula: |
      =GPT("Summarize this Dealership BDC row using only the provided evidence. Lead Source: " & A2 & ". Vehicle Interest: " & B2 & ". Source notes: " & C2 & ". Return summary, useful signal, missing data, and next action.")
...
A reliable save clay credits car dealers workflow usually has these columns:

| Column | What to put there | Why it matters |
|---|---|---|
| A | Lead Source | The record or account being researched |
| B | Vehicle Interest | The visible context that grounds the AI output |
| C | Appointment Status | The criteria, signal, or status used for classification |
| D | Service Or Trade-In Note | The operational status before the AI step |
...
<div class="seo-guide-inline-cta">
  <div>
    <strong>Prioritize dealership follow-up rows before buying more enrichment.</strong>
...
| Fit | Details |
|---|---|
| Best for | Dealership BDC, used-car dealers, internet sales directors who already keep lists, exports, or campaign research in Google Sheets and want a reviewable AI layer. |
...
Avoid creditworthiness, financing, or demographic inferences. No guaranteed savings.
