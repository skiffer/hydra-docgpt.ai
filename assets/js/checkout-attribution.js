...
(function () {
  ...
  function buildAttribution(extra) {
    ...
    return compact({
      ...
      utm_source: firstValue(getParam('utm_source'), extra.utm_source),
      utm_medium: firstValue(getParam('utm_medium'), extra.utm_medium),
      utm_campaign: firstValue(getParam('utm_campaign'), extra.utm_campaign),
      utm_content: firstValue(getParam('utm_content'), extra.utm_content),
      utm_term: firstValue(getParam('utm_term'), extra.utm_term),
