---
layout: "seo-guide"
title: "Recruiter Layoff-List Candidate Enrichment in Google Sheets"
permalink: "/recruiter-layoff-list-candidate-enrichment-google-sheets-ai/"
description: "Use GPT for Sheets to research, enrich, score, and QA recruiters and talent sourcers in Google Sheets. Includes copyable formulas, workflow steps, safety notes, and FAQ."
hero_title: "Recruiter Layoff-List Candidate Enrichment in Google Sheets"
...
inline_cta_title: "Run recruiters and talent sourcers research across every row"
inline_cta_text: "Install GPT for Sheets to create candidate summaries, role-fit labels, respectful outreach drafts, sensitive-context flags, and ATS handoff notes directly inside Google Sheets while keeping source columns and QA labels visible for review."
quick_start_title: "Quick start: Recruiter Layoff-List Candidate Enrichment in Google Sheets"
formula_section_title: "Copy-paste formulas for Recruiter Layoff-List Candidate Enrichment in Google Sheets"
...
quick_start_steps:
  - "Add columns for candidate name, public profile, previous role, skills evidence, location, target role, and consent/status notes."
