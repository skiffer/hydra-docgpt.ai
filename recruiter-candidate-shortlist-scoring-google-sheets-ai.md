---
layout: seo-guide
title: "Recruiter Candidate Shortlist Scoring in Google Sheets"
permalink: /recruiter-candidate-shortlist-scoring-google-sheets-ai/
description: "Recruiter Candidate Shortlist Scoring in Google Sheets shows how recruiters, staffing agencies, sourcers, and talent teams can use GPT for Sheets to turn rows of candidate name, role requirements, resume notes, profile summary, location, availability into match summaries, gap notes, interview questions, shortlist labels, and bias-review flags without leaving Google Sheets. Includes copyable formulas, workflow steps, use cases, QA guidance, FAQs, and CTAs for GPT for Sheets."
hero_title: "Recruiter Candidate Shortlist Scoring in Google Sheets"
hero_subtitle: "Recruiter Candidate Shortlist Scoring in Google Sheets shows how recruiters, staffing agencies, sourcers, and talent teams can use GPT for Sheets to turn rows of candidate name, role requirements, resume notes, profile summary, location, availability into match summaries, gap notes, interview questions, shortlist labels, and bias-review flags without leaving Google Sheets. Includes copyable formulas, workflow steps, use cases, QA guidance, FAQs, and CTAs for GPT for Sheets."
...
guide_badges:
  ...
  - "Lead enrichment"
  - "Sales workflow"
quick_start_title: "Quick start: Recruiter Candidate Shortlist Scoring in Google Sheets"
quick_start_steps:
  - "Add source columns for candidate name, role requirements, resume notes, profile summary, location, availability."
...
formula_section_title: "Copy-paste formulas for Recruiter Candidate Shortlist Scoring in Google Sheets"
...
Recruiter Candidate Shortlist Scoring in Google Sheets helps recruiters, staffing agencies, sourcers, and talent teams turn spreadsheet rows containing candidate name, role requirements, resume notes, profile summary, location, availability into match summaries, gap notes, interview questions, shortlist labels, and bias-review flags. The fastest path is to [install GPT for Sheets](/gpt-for-sheets/), keep source data in visible columns, paste one formula into row 2, review a sample, and then fill down.
...
- [recruiting agency Sheets workflow](/clay-alternative-for-recruiting-agencies-google-sheets-ai/)
- [staffing agency client research](/staffing-agency-client-research-google-sheets-ai/)
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How do I start Recruiter Candidate Shortlist Scoring in Google Sheets?",
      "acceptedAnswer": {
        "@type": "Answer",
