---
layout: seo-guide
title: "Enrich LinkedIn Sales Navigator Leads in Google Sheets with AI"
permalink: /linkedin-sales-navigator-export-enrichment-google-sheets-ai/
description: "Paste LinkedIn Sales Navigator export fields into Google Sheets and use GPT for Sheets to summarize roles, score fit, and draft outreach."
hero_title: "Enrich LinkedIn Sales Navigator Leads in Google Sheets with AI"
hero_subtitle: "Paste LinkedIn Sales Navigator export fields into Google Sheets and use GPT for Sheets to summarize roles, score fit, and draft outreach."
...
inline_cta_text: "Install GPT for Sheets to turn spreadsheets into reviewed AI research, scoring, and outreach workflows for SDRs, founders, agencies, recruiters, and RevOps teams working from LinkedIn lead exports."
guide_badges:
  - "GPT for Sheets"
  - "AI lead enrichment"
...
formula_section_intro: "Use these row-based formulas with columns like A: person · B: title/company · C: profile notes · D: offer or hiring context. Keep AI outputs in separate columns so every result can be reviewed before export."
formula_cards:
  - title: "Create the research brief"
    setup: "A: person · B: title/company · C: profile notes · D: offer or hiring context"
    formula: |
  ...
  - title: "Score and prioritize the row"
    setup: "A: person · B: title/company · C: profile notes · D: offer or hiring context · E: brief"
    formula: |
  ...
  - title: "QA the AI output"
    setup: "A: person · B: title/company · C: profile notes · D: offer or hiring context · E: AI output"
    formula: |
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Start with source columns similar to A: person · B: title/company · C: profile notes · D: offer or hiring context, then add separate AI output, QA, and next-action columns so every generated field can be reviewed."
      }
    },
    {
      "@type": "Question",
