---
layout: seo-guide
title: "Write Personalized Cold Email Lines in Google Sheets with AI"
permalink: /write-personalized-cold-email-lines-google-sheets-ai/
description: "Use GPT for Sheets to generate personalized outreach lines across every row: copy formulas, workflow steps, best-fit guidance, internal links, and FAQ for SDRs, founders, agencies, recruiters, and outbound teams."
hero_title: "Write Personalized Cold Email Lines in Google Sheets with AI"
hero_subtitle: "Use GPT for Sheets to generate personalized outreach lines across every row: copy formulas, workflow steps, best-fit guidance, internal links, and FAQ for SDRs, founders, agencies, recruiters, and outbound teams."
...
inline_cta_text: "Install GPT for Sheets to generate personalized outreach lines across every row. Test the prompts on a few rows, then fill down with review columns."
guide_badges:
  - "GPT for Sheets"
  - "AI lead enrichment"
...
quick_start_steps:
  - "Start with A: prospect/company \u00b7 B: persona \u00b7 C: verified note \u00b7 D: offer/CTA."
...
formula_section_intro: "Use these row-2 formulas with columns like A: prospect/company \u00b7 B: persona \u00b7 C: verified note \u00b7 D: offer/CTA. Keep AI outputs in separate columns so results can be reviewed before CRM updates, outreach, or client work."
formula_cards:
  - title: "Create the research brief"
    setup: "A: prospect/company \u00b7 B: persona \u00b7 C: verified note \u00b7 D: offer/CTA"
    formula: |
      =GPT("Create a concise research brief for Write Personalized Cold Email Lines in Google Sheets with AI. Inputs: " & A2 & " | " & B2 & " | " & C2 & " | " & D2 & ". Return 3 grounded bullets, one missing-data note, and one next action. Do not invent facts.")
    note: "Use this as the first AI column so every row gets the same reviewable structure."
  - title: "Score fit and priority"
    setup: "A: prospect/company \u00b7 B: persona \u00b7 C: verified note \u00b7 D: offer/CTA \u00b7 E: brief"
    formula: |
      =GPT("Score this enriched lead rows with source notes row for fit, urgency, and data quality. Inputs: " & A2 & " | " & B2 & " | " & C2 & " | " & D2 & " | " & E2 & ". Return JSON with score_1_to_5, reason, risk, and next_action.")
  ...
  - title: "Find missing fields"
    setup: "A: prospect/company \u00b7 B: persona \u00b7 C: verified note \u00b7 D: offer/CTA \u00b7 E: output"
    formula: |
  ...
  - title: "Create next-action options"
    setup: "A: prospect/company \u00b7 B: persona \u00b7 C: verified note \u00b7 D: offer/CTA \u00b7 E: score"
    formula: |
...
Write Personalized Cold Email Lines in Google Sheets with AI helps SDRs, founders, agencies, recruiters, and outbound teams use AI where list work already happens: inside Google Sheets. Start with enriched lead rows with source notes, keep trusted inputs in columns, and use [GPT for Sheets](/gpt-for-sheets/) formulas to produce research briefs, fit scores, next actions, QA notes, and reviewable outreach drafts.
...
## Why good personalization starts with specific inputs
...
**Best for:** teams that have verified context and want concise first lines, pain-point hooks, and CTA variants.

**Not best for:** spam, fabricated praise, unreviewed outreach, or compliance-sensitive campaigns without approval. Treat AI output as a structured draft, not a final decision system.
...
Start with `A: prospect/company · B: persona · C: verified note · D: offer/CTA`. Add separate AI output, score, next-action, and QA columns so every generated field can be reviewed.
