...
inline_cta_title: "Pre-qualify link and local SEO prospects in Sheets."
...
guide_badges:
  - "save clay credits seo"
  - "SEO teams"
  - "Copyable formulas"
  - "QA workflow"
quick_start_title: "Quick start"
quick_start_steps:
  - "Create columns for domain, topic, SERP or backlink note, contact status, AI output, QA flag, and next action."
...
formula_cards:
  - title: "Summarize each row"
    setup: "A: domain · B: topic · C: source notes"
    formula: |
      =GPT("Summarize this SEO teams row using only the provided evidence. Domain: " & A2 & ". Topic: " & B2 & ". Source notes: " & C2 & ". Return summary, useful signal, missing data, and next action.")
...
A reliable save clay credits seo workflow usually has these columns:

| Column | What to put there | Why it matters |
|---|---|---|
| A | Domain | The record or account being researched |
| B | Topic | The visible context that grounds the AI output |
| C | Serp Or Backlink Note | The criteria, signal, or status used for classification |
| D | Contact Status | The operational status before the AI step |
...
<div class="seo-guide-inline-cta">
  <div>
    <strong>Pre-qualify link and local SEO prospects in Sheets.</strong>
...
| Fit | Details |
|---|---|
| Best for | SEO teams, link-building agencies, local SEO agencies who already keep lists, exports, or campaign research in Google Sheets and want a reviewable AI layer. |
...
Avoid guaranteed SEO results, link outcomes, or savings. Compare workflow steps only.
