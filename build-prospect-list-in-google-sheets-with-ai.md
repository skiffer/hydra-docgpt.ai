---
layout: seo-guide
title: "Build a Prospect List in Google Sheets with AI"
permalink: /build-prospect-list-in-google-sheets-with-ai/
description: "Use GPT for Sheets to start a prospect list and enrich it with GPT for Sheets formulas: copy formulas, workflow steps, best-fit guidance, internal links, and FAQ for founders, small sales teams, agencies, and local businesses."
hero_title: "Build a Prospect List in Google Sheets with AI"
hero_subtitle: "Use GPT for Sheets to start a prospect list and enrich it with GPT for Sheets formulas: copy formulas, workflow steps, best-fit guidance, internal links, and FAQ for founders, small sales teams, agencies, and local businesses."
...
inline_cta_text: "Install GPT for Sheets to start a prospect list and enrich it with GPT for Sheets formulas. Test the prompts on a few rows, then fill down with review columns."
guide_badges:
  - "GPT for Sheets"
  - "AI lead enrichment"
...
quick_start_steps:
  - "Start with A: prospect/domain \u00b7 B: source/category \u00b7 C: known note \u00b7 D: ICP/offer."
...
formula_section_intro: "Use these row-2 formulas with columns like A: prospect/domain \u00b7 B: source/category \u00b7 C: known note \u00b7 D: ICP/offer. Keep AI outputs in separate columns so results can be reviewed before CRM updates, outreach, or client work."
formula_cards:
  - title: "Create the research brief"
    setup: "A: prospect/domain \u00b7 B: source/category \u00b7 C: known note \u00b7 D: ICP/offer"
    formula: |
      =GPT("Create a concise research brief for Build a Prospect List in Google Sheets with AI. Inputs: " & A2 & " | " & B2 & " | " & C2 & " | " & D2 & ". Return 3 grounded bullets, one missing-data note, and one next action. Do not invent facts.")
    note: "Use this as the first AI column so every row gets the same reviewable structure."
  - title: "Score fit and priority"
    setup: "A: prospect/domain \u00b7 B: source/category \u00b7 C: known note \u00b7 D: ICP/offer \u00b7 E: brief"
    formula: |
      =GPT("Score this seed lists, ICP notes, directories, and exported leads row for fit, urgency, and data quality. Inputs: " & A2 & " | " & B2 & " | " & C2 & " | " & D2 & " | " & E2 & ". Return JSON with score_1_to_5, reason, risk, and next_action.")
  ...
  - title: "Find missing fields"
    setup: "A: prospect/domain \u00b7 B: source/category \u00b7 C: known note \u00b7 D: ICP/offer \u00b7 E: output"
    formula: |
  ...
  - title: "Create next-action options"
    setup: "A: prospect/domain \u00b7 B: source/category \u00b7 C: known note \u00b7 D: ICP/offer \u00b7 E: score"
    formula: |
...
Build a Prospect List in Google Sheets with AI helps founders, small sales teams, agencies, and local businesses use AI where list work already happens: inside Google Sheets. Start with seed lists, ICP notes, directories, and exported leads, keep trusted inputs in columns, and use [GPT for Sheets](/gpt-for-sheets/) formulas to produce research briefs, fit scores, next actions, QA notes, and reviewable outreach drafts.
...
## Why pick an ICP and seed list before enrichment
...
**Best for:** users who want a practical prospecting worksheet with research, score, next action, and outreach draft columns.

**Not best for:** automated scraping, guaranteed contact discovery, or sending unreviewed messages. Treat AI output as a structured draft, not a final decision system.
...
Start with `A: prospect/domain · B: source/category · C: known note · D: ICP/offer`. Add separate AI output, score, next-action, and QA columns so every generated field can be reviewed.
